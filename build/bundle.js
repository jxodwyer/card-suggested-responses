...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./cardGeneric.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./cardGeneric.css");
...
var ArticleList = exports.ArticleList = function (_Component) {
  ...
  _createClass(ArticleList, [{
    ...
    value: function componentDidMount() {
      new _clipboard2.default('.button');
    }
  }, {
    key: 'render',
      ...
      return (0, _preact.h)(
        ...
        articles && articles.map(function (article) {
          ...
          return (0, _preact.h)(
            ...
            (0, _preact.h)(
              'div',
              { className: 'left floated middle aligned content' },
              (0, _preact.h)(
                'div',
                { className: 'header' },
                title
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)('i', { className: 'copy icon' })
              )
            )
          );
        })
...
exports.default = function () {
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      "div",
      { className: "ui header cardHeader" },
      "Knowledge Base"
    )
  );
};
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(11), __webpack_require__(24), __webpack_require__(18)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./articleList.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./articleList.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _ArticleList = __webpack_require__(3);
...
var CardSuggestedResponses = function (_Component) {
  _inherits(CardSuggestedResponses, _Component);

  function CardSuggestedResponses() {
    _classCallCheck(this, CardSuggestedResponses);

    var _this = _possibleConstructorReturn(this, (CardSuggestedResponses.__proto__ || Object.getPrototypeOf(CardSuggestedResponses)).call(this));

    _this.getArticles = _this.getArticles.bind(_this);
    _this.getPreview = _this.getPreview.bind(_this);
  ...
  _createClass(CardSuggestedResponses, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    key: 'getArticles',
    value: function getArticles(conversation) {
      var preview = this.getPreview(conversation) || '';
      var lowCasePreview = preview.toLowerCase();
      console.log('lowCasePreview', lowCasePreview);
      console.log('data', _data2.default);
      return _data2.default.filter(function (article) {
        return lowCasePreview.includes(article.match);
      });
    }
  }, {
    key: 'getPreview',
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        'div',
        { className: 'ui card mainCard' },
        (0, _preact.h)(_Header2.default, null),
        (0, _preact.h)('hr', { className: 'lineBreak' }),
        (0, _preact.h)(_ArticleList2.default, { articles: articles })
      );
    }
  }]);

  return CardSuggestedResponses;
}(_preact.Component);

(0, _preact.render)((0, _preact.h)(CardSuggestedResponses, null), document.body);
